...
export const Route = createFileRoute("/company/forgot-password")({
  head: () => ({
    meta: [
      { title: "Reset Company Password · WorkInEurope" },
      { name: "description", content: "Reset your company password on WorkInEurope." },
    ],
  }),
...
function CompanyForgotPassword() {
  ...
  return (
    <AuthShell
      ...
      subtitle="Enter your business email to receive a password reset link."
      footer={
        <>
