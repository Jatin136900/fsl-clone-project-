...
function CandidateSignin() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthShell, { side: "candidate", title: "Welcome back", subtitle: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    "Sign in to your candidate account.",
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signin", className: "underline underline-offset-4 text-foreground", children: "Hiring? Sign in as a company" })
  ] }), footer: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    "New to WorkInEurope?",
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/candidates/signup", className: "font-medium text-foreground underline underline-offset-4", children: "Create an account" })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(PrimaryButton, { disabled: loading, children: loading ? "Signing in…" : "Sign in" })
  ] }) });
}
export {
  CandidateSignin as component
};
